...
mixin _$DevicesState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(
            DeviceType? deviceType, List<ComparableDevice> devices)
        loaded,
  }) =>
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult Function(DeviceType? deviceType, List<ComparableDevice> devices)?
        loaded,
  }) =>
      throw _privateConstructorUsedError;
  @optionalTypeArgs
...
abstract class _$$DevicesLoadedCopyWith<$Res> {
  ...
  $Res call({DeviceType? deviceType, List<ComparableDevice> devices});
}
...
class _$DevicesLoaded implements DevicesLoaded {
  _$DevicesLoaded(
      {required this.deviceType, required final List<ComparableDevice> devices})
      : _devices = devices;
  ...
  @override
  String toString() {
    return 'DevicesState.loaded(deviceType: $deviceType, devices: $devices)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return loaded(deviceType, devices);
  }
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    return loaded?.call(deviceType, devices);
  }
...
abstract class DevicesLoaded implements DevicesState {
  factory DevicesLoaded(
      {required final DeviceType? deviceType,
      required final List<ComparableDevice> devices}) = _$DevicesLoaded;
