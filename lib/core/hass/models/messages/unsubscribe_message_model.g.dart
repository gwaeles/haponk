...
part of 'unsubscribe_message_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

Map<String, dynamic> _$UnsubscribeMessageModelToJson(
    UnsubscribeMessageModel instance) {
  ...
  val['subscription'] = instance.subscription;
  return val;
}
